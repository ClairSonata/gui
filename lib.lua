...
local Themes = {
	...
	Dark = {
		...
		Toggle = Color3.fromRGB(0,32,255),
		ToggleAccent = Color3.fromRGB(0,32,255),
		Dropdown = Color3.fromRGB(0,0,0),
		DropdownAccent = Color3.fromRGB(0,32,255),

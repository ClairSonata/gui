...
local function createOptionHolder(holderTitle, parent, parentTable, subHolder)
	...
	local close
	if subHolder then
		close = library:Create("ImageLabel", {
			AnchorPoint = Vector2.new(0.5, 0.5),
			Position = UDim2.new(0.5, 0, 0.5, 0),
			Size = UDim2.new(2,-size - 10, 2,-size - 10),
			Rotation = parentTable.open and 45 or 180,
			BackgroundTransparency = 1,
			Image = "rbxassetid://3944675151",
			ImageColor3 = parentTable.open and Color3.fromRGB(50,50,50) or Color3.fromRGB(244, 157, 255),
		...
		close = library:Create("ImageLabel", {
			...
			ImageColor3 = parentTable.open and Color3.fromRGB(46, 255, 255) or Color3.fromRGB(50,50,50),
			ScaleType = Enum.ScaleType.Fit,
			Parent = closeHolder
		})
	end
	...
	if not subHolder then
		...
		local grade =  library:Create("UIGradient",{
			Name = "line",
			Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(46, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(228, 92, 255))},
			Parent = line
		})
	end
	...
	closeHolder.InputBegan:connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 then
			...
			if subHolder then
				tweenService:Create(close, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Rotation = parentTable.open and 45 or 180, ImageColor3 = parentTable.open and  Color3.fromRGB(50,50,50) or Color3.fromRGB(244, 157, 255)}):Play()
			else 
				tweenService:Create(close, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Rotation = parentTable.open and 45 or 180, ImageColor3 = parentTable.open and Color3.fromRGB(46, 255, 255) or Color3.fromRGB(50,50,50)}):Play()
...
local function createLabel(option, parent)
	local main = library:Create("TextLabel", {
		...
		TextColor3 = Color3.fromRGB(255, 188, 250),
...
function createToggle(option, parent)
	...
	local tickboxOutline = library:Create("ImageLabel", {
		...
		BackgroundTransparency = 1,
		Image = "rbxassetid://3570695787",
		ImageColor3 = option.state and Color3.fromRGB(46, 255, 255) or Color3.fromRGB(100, 100, 100),
		ScaleType = Enum.ScaleType.Slice,
		SliceCenter = Rect.new(100, 100, 100, 100),
		SliceScale = 0.02,
		Parent = main
	...
	local tickboxInner = library:Create("ImageLabel", {
		...
		BackgroundTransparency = 1,
		Image = "rbxassetid://3570695787",
		ImageColor3 = option.state and Color3.fromRGB(46, 255, 255) or Color3.fromRGB(20, 20, 20),
		ScaleType = Enum.ScaleType.Slice,
		SliceCenter = Rect.new(100, 100, 100, 100),
		SliceScale = 0.02,
	...
	main.InputBegan:connect(function(input)
		...
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			...
			if not option.state then
				tweenService:Create(tickboxOutline, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(214, 214, 214)}):Play()
			end
		end
	end)
	...
	function option:SetState(state)
		...
		tweenService:Create(tickboxInner, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = state and Color3.fromRGB(46, 255, 255) or Color3.fromRGB(20, 20, 20)}):Play()
		if state then
			tweenService:Create(tickboxOutline, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(46, 255, 255)}):Play()
		else
			if inContact then
...
function createButton(option, parent)
	...
	main.InputBegan:connect(function(input)
		...
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			inContact = true
			tweenService:Create(round, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(178, 101, 255)}):Play()
		end
	end)
	...
	main.InputEnded:connect(function(input)
		...
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			...
			if not clicking then
				tweenService:Create(round, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(255,255,255)}):Play()
			end
		end
	end)
end
...
local function createSlider(option, parent)
	...
	local fill = library:Create("ImageLabel", {
		BackgroundTransparency = 1,
		Image = "rbxassetid://3570695787",
		ImageColor3 = Color3.fromRGB(228, 92, 255),
		ScaleType = Enum.ScaleType.Slice,
		SliceCenter = Rect.new(100, 100, 100, 100),
		SliceScale = 0.02,
		Parent = slider
	...
	local circle = library:Create("ImageLabel", {
		...
		BackgroundTransparency = 1,
		Image = "rbxassetid://3570695787",
		ImageColor3 = Color3.fromRGB(46, 255, 255),
		ScaleType = Enum.ScaleType.Slice,
		SliceCenter = Rect.new(100, 100, 100, 100),
		SliceScale = 1,
		Parent = slider
	...
	main.InputBegan:connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 then
			tweenService:Create(fill, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(228, 92, 255)}):Play()
			tweenService:Create(circle, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.new(3.5, 0, 3.5, 0), ImageColor3 = Color3.fromRGB(46, 255, 255)}):Play()
			sliding = true
		...
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			...
			if not sliding then
				tweenService:Create(fill, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(228, 92, 255)}):Play()
				tweenService:Create(circle, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.new(2.8, 0, 2.8, 0), ImageColor3 = Color3.fromRGB(46, 255, 255)}):Play()
			end
		end
	end)
	...
	main.InputEnded:connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 then
			...
			if inContact then
				...
				tweenService:Create(fill, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(228, 92, 255)}):Play()
				tweenService:Create(circle, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.new(0, 0, 0, 0), ImageColor3 = Color3.fromRGB(46, 255, 255)}):Play()
			end
		end
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			inContact = false
			...
			if not sliding then
				tweenService:Create(fill, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(228, 92, 255)}):Play()
				tweenService:Create(circle, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.new(0, 0, 0, 0), ImageColor3 = Color3.fromRGB(228, 92, 255)}):Play()
			end
		end
	end)
...
local function createList(option, parent, holder)
	...
	function option:RemoveAll(value)
		for _,label in next, content:GetChildren() do
			if label:IsA"TextLabel"  then
				label:Destroy()
				valueCount = valueCount - 1
